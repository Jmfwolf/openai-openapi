...
public class Engine {
  ...
  **/
  ...
  public Engine _object(String _object) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, engine.id) &&
        Objects.equals(this._object, engine._object) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, created, ready);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Engine.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
